          ...
          <MDBCol col="6">
            <div className="d-flex flex-column  justify-content-center gradient-custom-2 h-100 mb-4">
              <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">
                  Chào mừng bạn đến với phần quản trị BẾP CỦA BỐ
                </h4>
                <p class="small mb-0">
                  Chào mừng bạn đến với Bếp của Bố - nơi chia sẻ niềm đam mê ẩm
                  thực và hương vị đặc trưng. Chúng tôi là một blog ẩm thực đầy
                  màu sắc, nơi bạn có thể khám phá các công thức nấu ăn ngon
                  lành, tìm hiểu về các món ăn truyền thống và khám phá những ý
                  tưởng sáng tạo để làm mới bữa ăn hàng ngày.
                </p>
              </div>
            </div>
          </MDBCol>
